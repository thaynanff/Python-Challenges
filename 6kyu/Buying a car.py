...
A man has a rather old car being worth $2000. He saw a secondhand car being worth $8000. He wants to keep his old car until 
he can buy the secondhand one.

He thinks he can save $1000 each month but the prices of his old car and of the new one decrease of 1.5 percent per month. 
Furthermore this percent of loss increases of 0.5 percent at the end of every two months. Our man finds it difficult to make 
...
def nbMonths(startPriceOld, startPriceNew, savingperMonth, percentLossByMonth):
    ...
    while True:
        ...
        if save + startPriceOld >= startPriceNew:
            break
    return [nm-1, round(startPriceOld + save - startPriceNew)]
